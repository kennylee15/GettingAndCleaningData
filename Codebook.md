...
1. The original dataset was split into subject, activity, and features, each of which were further split into test and train sets. Merging was performed to get everything in one dataset.

2. "Train" and "Test" tables for Subject, Activity, and Features were combined using rbind respectively.

3. Features table was merged with FeatureNames table which contains the names of the variables.

4. Subject, Activity, and Features were melted into a single data frame.

5. The data frame was filtered to subset all variables that contain mean() or std().

6. Variable names were replaced with more descriptive ones.

7. An average of each variable was calculated.

6. The dataset is then written to `tidydata.txt` file
